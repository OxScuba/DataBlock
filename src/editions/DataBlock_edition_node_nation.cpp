...
#include "media/160x160_pxl/160x160_esp_node_nation.h"
#include "media/320x170_pxl/320x170_esp_node_nation_mempool.h"
...
void displayScreen1() {
  ...
  tft.fillScreen(TFT_WHITE);
  tft.pushImage(160, 5, 160, 160, b160x160_esp_node_nation);
  tft.setTextSize(2);
...
void displayScreen2() {
  ...
  tft.fillScreen(TFT_WHITE);
  tft.pushImage(0, 0, 320, 170, b320x170_esp_node_nation_mempool);  

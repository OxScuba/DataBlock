...
#include "media/320x170_pxl/320x170_esp_events_countdown_meetup_breizh_bitcoin.h"
...
void displayScreen3() {
  ...
  tft.fillScreen(TFT_WHITE);
  tft.pushImage(0, 0, 320, 170, b320x170_esp_events_countdown_meetup_breizh_bitcoin);
  tft.setTextSize(2);
  tft.setTextColor(TFT_WHITE);

...
#include "media/160x160_pxl/160x160_esp_meetup_dijon.h"
#include "media/320x170_pxl/320x170_esp_mempool.h"
#include "media/320x170_pxl/320x170_esp_events_countdown_meetup_dijon.h"
...
void displayScreen1() {
  ...
  tft.fillScreen(TFT_WHITE);
  tft.pushImage(160, 5, 160, 160, b160x160_esp_meetup_dijon);
  tft.setTextSize(2);
...
void displayScreen3() {
  ...
  tft.fillScreen(TFT_WHITE);
  tft.pushImage(0, 0, 320, 170, b320x170_esp_events_countdown_meetup_dijon);
  tft.setTextSize(2);
  tft.setTextColor(TFT_BLACK);

...
#include "media/320x170_pxl/320x170_esp_planb_network.h"
#include "media/320x170_pxl/b320x170_esp_planb_network_mempool.h"
#include "media/320x170_pxl/320x170_esp_events_countdown_planb_network.h"
...
WiFiManagerParameter month_param("month", "Month", "5", 2);
...
void loadConfigFromPreferences() {
  ...
  targetDateTime.Month = preferences.getUInt("month", 5);
...
void displayScreen1() {
  ...
  tft.pushImage(0, 0, 320, 170, ballArrayNetwork[0]);
  tft.setTextSize(2);
...
void displayScreen2() {
    ...
    tft.fillScreen(TFT_WHITE);
    tft.pushImage(0, 0, 320, 170, ballArrayMempool[0]);  
...
void displayScreen3() {
  ...
  tft.fillScreen(TFT_WHITE);
  tft.pushImage(0, 0, 320, 170, ballArrayCountdown[0]);
  tft.setTextSize(2);
  tft.setTextColor(TFT_WHITE);

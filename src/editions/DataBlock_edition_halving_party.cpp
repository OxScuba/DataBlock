...
#include "media/160x160_pxl/160x160_esp_breizh_bitcoin.h"
#include "media/320x170_pxl/320x170_esp_breizh_bitcoin_mempool.h"
#include "media/320x170_pxl/320x170_esp_events_countdown_halving_party.h"
...
void displayScreen2() {
  ...
  tft.fillScreen(TFT_WHITE);
  tft.pushImage(0, 0, 320, 170, b320x170_esp_breizh_bitcoin_mempool);  
...
void displayScreen3() {
  ...
  tft.fillScreen(TFT_WHITE);
  tft.pushImage(0, 0, 320, 170, b320x170_esp_events_countdown_halving_party);
  tft.setTextSize(2);
